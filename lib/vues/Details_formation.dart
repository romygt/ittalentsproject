...
class Details_formation extends StatefulWidget {
  ...
  Details_formation(
      {@required this.rating, @required this.imgUrl, @required this.title,@required this.date, @required this.confirmed,@required this.duration,@required this.partenaire,@required this.content,@required this.formateur,@required this.link});
          ...
          SizedBox(
              ...
              child: GestureDetector(
                ...
                child: Container( alignment:Alignment.center,
                    decoration: BoxDecoration(
                        color: Color(0xff5A6C64), borderRadius: BorderRadius.circular(16)),
